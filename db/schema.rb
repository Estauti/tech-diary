...
ActiveRecord::Schema.define(version: 2020_01_03_001002) do
  ...
  create_table "contributions", force: :cascade do |t|
    ...
    t.index ["discovery_id"], name: "index_contributions_on_discovery_id"
  ...
  add_foreign_key "contributions", "discoveries"
